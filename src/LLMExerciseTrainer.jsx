...
export default function FormPerfect() {
  ...
  useEffect(() => {
    ...
    fetch("https://exercise-trainer-app-1.onrender.com/api/exercises?musclegroup=${muscleGroup}")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    ...
    fetch("https://exercise-trainer-app-1.onrender.com/api/exercise-details?musclegroup=${muscleGroup}&exercise_name=${selectedExercise}")
      .then((res) => res.json())
